...
if __name__ == '__main__':
    ...
    IMG_ROOT = r'E:\cv_final\CV_Final_Project-xxy\dataset\test_dataset\jiguang\pngs'   # 图片路径
    XML_ROOT = r'E:\cv_final\CV_Final_Project-xxy\dataset\test_dataset\jiguang\xmls'   # ground truth:图片对应xml标注文件路径 
    OTT_IMG_ROOT = r'E:\cv_final\CV_Final_Project-xxy\eval_output'  # 漏报误报错误可视化图片路径
    CSV_PATH = r'E:\cv_final\CV_Final_Project-xxy\output\jiguang.csv'       # our prediction算法输出结果： img_name, x_min y_min w h, confidence, CLASS_NAME   
