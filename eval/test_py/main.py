...
if __name__ == '__main__':
    ...
    IMG_ROOT = r'E:\cv_final\CV_Final_Project-xxy\dataset\train_dataset\coredraw\frame_1.png'   # 图片路径
    XML_ROOT = r'E:\cv_final\CV_Final_Project-xxy\dataset\train_dataset\coredraw\frame_1.xml'      # 图片对应xml标注文件路径 ground truth
    OTT_IMG_ROOT = r'E:\cv_final\CV_Final_Project-xxy\eval_output'  # 漏报误报错误可视化图片路径
    CSV_PATH = r'E:\cv_final\CV_Final_Project-xxy\output\coredraw.csv'       # 算法输出结果： img_name, x_min y_min w h, confidence, CLASS_NAME   our prediction
