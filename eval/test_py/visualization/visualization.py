...
def drawing(recalls, precisions, CLASS_NAME, IOU_THRESH, ap, eval_output, CSV_PATH):
    # 画图
    ...
    name = f"{eval_output}{filename}_{CLASS_NAME}_{IOU_THRESH}.png"
    plt.savefig(name, dpi=300)  # 保存图片
    #plt.show()